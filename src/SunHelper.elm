...
-- review 8.11.2023: elm-review src/
-- MODEL
...
meanAnomalSun cent =
    357.52911 + cent * (35999.05029 + cent * 0.0001537) |> decNorm360
...
calcSunML cent =
    let
        ...
        c =
            3.032e-4
    in
    280.46646 + cent * (36000.76983 + cent * c) |> decNorm360
...
civTwlMns : InputData -> Float -> Float
...
morningToNoon inputData =
    ...
    if declination < 0.0 && geoLat > (90.83 + declination) then
        ...
        if dayLength > 0.0 && dayLength < 24.0 then
            ...
            " Daylength Exception: " ++ String.fromFloat dayLength
