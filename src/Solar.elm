...
gw =
    Model "2022" "9" "23" "1" "4" "27" "51.4825766" "-0.0076589" "0"


gwDate =
    gw.year ++ "-" ++ gw.month ++ "-" ++ gw.day


preZero =
    if String.length gw.minute == 1 then
        "0"
...
gwTime =
    gw.hour ++ ":" ++ preZero ++ gw.minute ++ ":" ++ gw.second
...
gwAutumnEquinoxDeclination =
    sunDeclination gw


gwt =
    Model "2022" "9" "23" "11" "52" "33" "50" "0.00" "0"


gwAltNoon =
    90 - SunHelper.solZenith gwt


gwAzimNoon =
    SunHelper.solAzimuth gwt
...
main =
    div [ style "margin" "2em" ]
        ...
        , p []
            [ text
                ("Autumn Equinox Solar Declination: "
