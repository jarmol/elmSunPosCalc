module Primes320k exposing (main)
...
main =
  element { init = \ _ -> ( ( 0
                            , "The primes up to 320 000 are:  " ++
                                (primesTreeFolding() |> uptoCIS2List 320000
...
-- Found 27608 primes to 320000 in 258 milliseconds.
--
-- https://ellie-app.com/m9nKRgCk8NZa1
