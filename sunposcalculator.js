...
var author$project$Main$mnToHrMn = function (mns) {
	...
	var lmins = elm$core$Basics$floor(mns) % 60;
...
var author$project$Main$viewDeclination = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						' Day Length        = ' + author$project$Main$formTime(
							author$project$Main$getDayLength(model)))
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'margin-right', '50%')
					]),
				_List_fromArray(
					[
						elm$html$Html$text('This programm contains the basic functions to be used in calculation of solar positions,' + ' Sunrise and Sunset times for the given geographic location, date and time.')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('The code is written in Elm-programming language version 0.19.0')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('© J. Lammi 2019')
					]))
			]));
};
...
var author$project$Main$atan2Deg = F2(
	function (x, y) {
		return author$project$Main$toDeg(
...
var author$project$Main$rectAsc = function (cent) {
	...
	return A2(
		...
		author$project$Main$cosDeg(appLongS));
};
var author$project$Main$viewJD = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('DATE AND LOCATION USED BELOW')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
...
var author$project$Main$getInputValue = function (laji) {
	return A2(
		elm$core$Maybe$withDefault,
		0,
...
var author$project$Main$viewValidation = function (model) {
	return ((author$project$Main$getInputValue(model.month) > 0) && ((author$project$Main$getInputValue(model.month) < 13) && ((author$project$Main$getInputValue(model.day) > 0) && (author$project$Main$getInputValue(model.day) < 32)))) ? A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text('Date entry OK')
			])) : A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				elm$html$Html$text('Incorrect month or day')
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Sun Position Calculator')
					])),
				A2(
				elm$html$Html$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						author$project$Main$viewDeclination(model),
