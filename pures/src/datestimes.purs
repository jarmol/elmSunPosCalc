...
main =
  ...
  log $ "mkTime 14 24 05 100 : " <> show (mkTime 14 24 5 100) -- valid
  log $ "mkTime 23 33 30 0 " <> show (mkTime 23 33 30 0) -- valid
  ...
  log $ "mkCanonicalDate 2023 May 17: " <> show (mkCanonicalDate 2023 May 17)
