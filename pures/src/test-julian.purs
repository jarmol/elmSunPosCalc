...
main  =
  ...
  log $  ("div 13 2 == 6 "   <> show ( div 13 2 == 6 ))
  log $  ("13 // 2 == 6 "    <> show ( 13 // 2 == 6 ))
  log $  ("-13 // 2 == -6 "   <> show ( -13 // 2 == -6 ))
  log $  ("-12 // 12 == -1 "  <> show ( -12 // 12 == -1 ))
  log $  ("12 // 12 == 1 "   <> show ( 12 // 12 == 1 ))
  log $  ("negdiv 13 2 == 6 "    <> show ( negdiv 13 2 == 6 ))
  log $  ("negdiv (-13) 2 == -6 " <> show ( negdiv (-13) 2 == -6 ))
  log $  (printAB 2023 3 24)
  log $  (printAB 2026 7 25)
  log $  (printAB 2026 7 26)
  log $  (printAB 2020 2 29)
  log $  (printAB 2020 3 1)  
  log $  ("Weekday 2026-07-25 = ") <> ( weekday 2026 7 25 )
  log $  ("Weekday 2026-07-26 = ") <> ( weekday 2026 7 26 )
  log $  ("Weekday 2026-07-27 = ") <> ( weekday 2026 7 27 )
